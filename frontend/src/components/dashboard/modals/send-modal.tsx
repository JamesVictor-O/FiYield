...
import { useVaultSend, useVaultBalance } from "@/hooks/contract/useVault";
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Input
              ...
              disabled={isLoading}
              className="font-mono text-sm w-full h-12 border-gray-300 focus:border-gray-900 focus:ring-0"
            />
            {recipientAddress && (
              <p className="text-xs text-gray-500 font-pop">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {[50, 100, 250, 500, 1000, 2500].map((quickAmount) => (
                <Button
                  ...
                  disabled={isLoading}
                  className="text-xs font-pop border-gray-300 hover:border-gray-900 hover:bg-gray-50 h-10"
                >
          ...
          <div className="border border-gray-200 rounded-lg p-4 space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-gray-500 font-pop">Recipient</span>
              <span className="font-mono text-xs font-pop">
                {recipientAddress
            ...
            <div className="flex justify-between text-sm">
              <span className="text-gray-500 font-pop">Send Amount</span>
          ...
          <div className="border border-yellow-200 bg-yellow-50 rounded-lg p-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-yellow-800 font-pop">
